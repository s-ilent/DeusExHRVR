...
SamplerState p_default_Material_05A07024649625_05142B6415252097_DepthBufferTexture_sampler_s : register(s0);
SamplerState p_default_Material_05A077A4425906_Texture_sampler_s : register(s1);
Texture2D<float4> p_default_Material_05A07024649625_05142B6415252097_DepthBufferTexture_texture : register(t0);
Texture2D<float4> p_default_Material_05A077A4425906_Texture_texture : register(t1);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = 1 / r0.x;
  r0.yzw = -CameraPosition.xyz + v3.xyz;
  r0.y = dot(r0.yzw, CameraDirection.xyz);
  r0.x = -r0.y + r0.x;
  r0.x = saturate(r0.x / MaterialParams[0].x);
  r0.yzw = p_default_Material_05A077A4425906_Texture_texture.Sample(p_default_Material_05A077A4425906_Texture_sampler_s, v2.xy).xyz;
  r0.yzw = v1.xyz * r0.yzw;
  r0.xyz = r0.yzw * r0.xxx;
  r1.xyz = r0.xyz + r0.xyz;
  r0.xyz = -r0.xyz * float3(2,2,2) + FogColor.xyz;
  r0.w = saturate(v3.w);
