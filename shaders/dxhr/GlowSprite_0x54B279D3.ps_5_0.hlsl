  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.z = p_default_Material_0821DF245161732_DepthBufferTexture_texture.Sample(p_default_Material_0821DF245161732_DepthBufferTexture_sampler_s, uv).x;
  r0.xy = uv * DepthToView.xy + DepthToView.zw;
  ...
  r0.y = 1 / r0.y;
  r0.yzw = InstanceParams[5].xyz * r0.y;
  o0.xyz = r0.yzw * r0.x;
